...
const navigation = [
  { name: "home", href: "/", role: ["ADMIN", "MANAGER"] },
  { name: "team", href: "/team", role: ["ADMIN", "MANAGER"] },
  { name: "product", href: "/product", role: ["ADMIN", "MANAGER"] },
  { name: "calendar", href: "/calendar", role: ["ADMIN"] },
  { name: "entrepot", href: "/entrepot", role: ["ADMIN"] },
  { name: "vendres", href: "/", role: ["VENDEUR"] },
];
                    ...
                    <div className="lg:grid lg:grid-cols-3 lg:gap-8 lg:items-center">
                      ...
                      <div className="hidden lg:block lg:col-span-2">
                        <nav className="flex space-x-4">
                          {navigation.map(
                            (item) =>
                              hasAnyRole(roles, item.role) && (
                                <a
                                  key={item.name}
                                  onClick={() => navigate(item.href)}
                                  className={classNames(
                                    item.name == splitLocation[1]
                                      ? "text-white"
                                      : "text-cyan-100",
